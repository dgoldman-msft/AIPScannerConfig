...
Remove-Module AIPScannerConfig -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\AIPScannerConfig.psd1"
Import-Module "$PSScriptRoot\..\AIPScannerConfig.psm1" -Force
